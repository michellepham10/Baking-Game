...
public class GameGUI extends JComponent implements KeyListener
{
  ...
  //private boolean atStrawberries;
  private boolean atBowl;
  ...
  */
  ...
  {    
    ...
    flour = new Rectangle(0,0, 30, 30);
    strawberries = new Rectangle(50,50,800,400);
    Bowl bowl = new Bowl();
  ...
  private void movePlayer(int incrx, int incry)
  {
    ...
    if(!((currX+incrx < 0 || currX+incrx > WIDTH-60)))currX += incrx;
  ...
  // {
  //   atFlour = flour.contains(playerLoc);
  //   atStrawberries = strawberries.contains(playerLoc);  
  //   atBowl = bowl.contains(playerLoc);
...
private void pickupIngredient()
  {
    ...
    if (flour.getWidth() > 0 && flour.contains(playerLoc))
      {
        flour.setSize(0,0);
        //atFlour = false;
        repaint();
    ...
    if (strawberries.getWidth() > 0 && strawberries.contains(playerLoc))
      {
        strawberries.setSize(0,0);
        //atStrawberries = false;
        repaint();
  ...
  */
  ...
  public void paintComponent(Graphics g)
  {
    ...
    if (flour.getWidth() > 0) g.drawImage(flourImage, (int)flour.getX(), (int)flour.getY(), null);
    if (strawberries.getWidth() > 0) g.drawImage(strawberriesImage, (int)strawberries.getX(), (int)strawberries.getY(), null);
